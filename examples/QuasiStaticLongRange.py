...
with h5py.File(os.path.join(os.path.dirname(__file__), "QuasiStaticLongRange.h5")) as file:
...
if plot:
    ...
    axes[0].plot(ret_x_frame, ret_f_frame)
    axes[1].plot(system.x)
    plt.show()
